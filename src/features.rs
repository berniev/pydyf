...
impl Feature {
    pub const fn min_version(self) -> Version {
        ...
        use Version::*;
        match self {
            ExternalLinks | ArticleThreads | Password | DeviceIndependentColor => V1_1,
            ...
            TwoByteCidFonts | Opi20 | AddtlColorSpaces | SmoothShading | Annotations
            | DigitalSignatures | JavaScriptActions | Rc4Encryption => V1_3,

            Transparency | JavaScript15 | TaggedPdf | Jbig2Compression | RC4Encryption128bit => {
                V1_4
            }
